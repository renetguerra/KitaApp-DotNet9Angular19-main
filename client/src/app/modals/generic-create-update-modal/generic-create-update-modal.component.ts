...
import { Component, HostListener, Input, OnInit, ViewChild, inject, input, signal, viewChild } from '@angular/core';
...
import { GenericItem, TableColumn } from 'src/app/_models/generic';
