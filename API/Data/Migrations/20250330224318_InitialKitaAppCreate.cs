...
{
    /// <inheritdoc />
    public partial class InitialKitaAppCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TutorPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TutorPhotos_Tutors_TutorId",
                        column: x => x.TutorId,
                        principalTable: "Tutors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentPhotos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FamilyMemberPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FamilyMemberPhotos_FamilyMembers_FamilyMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FamilyMemberPhotos_FamilyMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentPhotos_UserId",
                table: "StudentPhotos",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TutorPhotos_TutorId",
                table: "TutorPhotos",
                column: "TutorId");
